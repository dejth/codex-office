...
4. [x] Enable private vulnerability reporting and configure branch protection/CODEOWNERS on GitHub.
5. [x] Create a GitHub Project using `docs/product/PROJECT_BOARD.md` and seed the listed issues.
6. [x] Run `corepack enable`, `pnpm install`, and `pnpm check`.
7. [x] Commit the foundation before starting provider research.
