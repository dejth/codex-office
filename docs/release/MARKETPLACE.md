...
Version 0.1.1 was published with explicit maintainer approval on 2026-07-30 for
...
Version 0.1.2 was published manually with explicit maintainer approval on
2026-07-30. It adds runtime-probed persisted inventory, verified Shared observer
fallback, and clearer user-facing Marketplace details. Its engineering and
publication evidence is tracked in
[`V0.1.2_VALIDATION.md`](V0.1.2_VALIDATION.md). The agent prepared the reviewed
VSIX and checksum; the maintainer performed Upload/Publish manually.
